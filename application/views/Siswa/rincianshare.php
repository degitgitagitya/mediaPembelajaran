          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="row">
                  <div class="col">
                    <h3 class="m-0 font-weight-bold text-primary">Rincian Tahap <i>Share</i> Anda</h3>
                  </div>
                  <div class="col-auto">
                ...
                <div class="card-body text-justify">
                  Halaman ini memuat daftar post rekaman <?php $siswa->nama_user ?> huruf <?php echo $nama_sub; ?> yang telah dibagikan ke forum oleh Anda. Anda juga dapat melihat siapa saja yang sudah menilai post rekaman tersebut beserta dengan nilai yang diberikannya.
                </div>
              </div>

...
class Model_guru extends CI_Model{
	...
	function hasilrekamanbyId($id){
		$query = $this->db->query("SELECT submateri.id_materi, submateri.nama_submateri, submateri.huruf_submateri, rekaman_tugas.id, rekaman_tugas.submateri, rekaman_tugas.video, materi.nama_materi, materi.arab_materi, user.username_user, user.nama_user FROM submateri RIGHT JOIN rekaman_tugas ON submateri.id_submateri = rekaman_tugas.submateri RIGHT JOIN user ON rekaman_tugas.username = user.id_user RIGHT JOIN materi ON rekaman_tugas.materi = materi.id_materi WHERE rekaman_tugas.id = '$id'");
		return $query->row();
	}

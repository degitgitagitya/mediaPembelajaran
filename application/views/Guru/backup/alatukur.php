            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                <div class="card-body">
                  ...
                  Di halaman ini Anda dapat melihat nilai <i>Creative Learning</i> masing-masing siswa. Anda juga dapat mengunduh laporan nilai <i>Creative Learning</i> seluruh siswa <a href="<?php echo site_url('Controller_guru/report') ?>" class="text-decoration-none">disini</a>
                </div>
              </div>

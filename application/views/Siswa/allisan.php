...
<head>
    ...
    <title>Al-Lisan (اللِّسَانُ)</title>
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Ada 5 macam:</h6>
                  ...
                  <a class="collapse-item active" href="<?php echo site_url('materi/3/3')?>">Al-Lisan (اللِّسَانُ)</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid mb-5">
          <div class="row justify-content-center">
            <div class="col-5">
              <h3 class="text-center font-weight-bold text-primary">Al-Lisan (اللِّسَانُ)</h3>
              <hr>
            </div>
          </div>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body" style="font-size: 14pt">
              <?php echo $listmateri[2]->uraian_materi; ?>
              <div class="text-center mt-1" style="font-size:12pt">
                <?php
                  $materi = str_replace('-', '', $listmateri[2]->nama_materi);
                  if ($status[$materi] != -1) {
                ?>
                ...
                <?php }else{ ?>
                  <a class="btn btn-success" href="<?php echo site_url('soal/'.$listmateri[2]->nama_materi.'/null') ?>">Kerjakan soal</a>
                <?php } ?>
              </div>
            </div>
          </div>

          <?php if (!empty($listmateri[2]->tipstrik_materi)) {?>
            <div class="card shadow mb-4">
              <!-- Card Header - Dropdown -->
              ...
              <!-- Card Body -->
              <div class="card-body" style="font-size: 14pt">
                <?php echo $listmateri[2]->tipstrik_materi ?>
              </div>
            </div>
          <?php } ?>
              ...
              <div class="card-body" style="font-size: 14pt">
                <video id="myVideo" controls style="width: 100%; height:300px;">
                  ...
                  <div style="font-size:12pt">
                    ...
                    <?php }else{ ?>
                      <a class="btn btn-success" href="<?php echo site_url('soal/'.$listmateri[2]->nama_materi.'/'.$huruf->nama_submateri) ?>">Kerjakan soal</a>
                    <?php } ?>
                  </div>
              </div>
            </div>
            ...
            <table width="100%">
              <tbody>
                <td class="text-center">
                  ...
                  <a href="<?php echo site_url('materi/3/'.$sub->id_submateri) ?>" class="gambar text-decoration-none">
  ...
  <!-- End of Page Wrapper -->
    ...
    <script>
      <?php if ($status['tugas'.$huruf->id_submateri] == -1) { ?>
        ...
        function playvideo(){
          $.ajax({
           url:"<?php echo site_url('Controller_siswa/analitik/playvideo/'.$listmateri[2]->nama_materi.'/'.$huruf->nama_submateri) ?>",
           method:"POST",

            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                <div class="card-body">
                  ...
                  Disini Anda dapat memantau aktivitas harian atau 7 hari terakhir siswa, Anda dapat memastikan apakah siswa aktif dalam forum diskusi, berusaha mencoba membuat rekaman, atau membaca materi-materi yang telah disediakan.
                </div>
              </div>
              ...
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Siswa Memutar Video Materi</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="row form-group align-items-center">
              ...
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Siswa Mencoba Membuat Rekaman</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="row form-group align-items-center">
              ...
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Siswa yang Berdiskusi</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="row form-group align-items-center">

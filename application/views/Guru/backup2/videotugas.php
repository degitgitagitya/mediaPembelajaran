        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12">
              <form action="<?php echo site_url('Controller_guru/nilaitugas/'.$rekaman->id.'/'.$rekaman->username_user.'/'.$rekaman->submateri) ?>" method="POST">
                <div class="card shadow mb-4">
                  <!-- Card Header - Dropdown -->
                  <div class="card-header py-0">
                    <div class="row mt-3">
                      <div class="col">
                        <h4 class="m-0 font-weight-bold text-primary"><?php echo $rekaman->nama_user; ?></h4>
                      </div>
                      <div class="col-auto">
                        <a href="<?php echo site_url('guru/tugassiswa') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                          <span class="icon">
                    ...
                    <h6><?php echo $rekaman->nama_materi.' '.$rekaman->arab_materi.' Huruf '.$rekaman->nama_submateri.'('.$rekaman->huruf_submateri.')'; ?></h6>
                      ...
                      <div class="col-xl-6 col-lg-6">
                        <div class="embed-responsive embed-responsive-16by9 align-middle mb-2">
                          <video class="video-fluid" controls>
                            <source src="<?php echo base_url('uploads/tugas/'.$rekaman->video) ?>" type="video/webm">
                      ...
                      <div class="col-xl-6 col-lg-6">
                        <div class="row form-group">
                          ...
                          <div class="col-xl-10 col-xl-10 text-center">
                            <input type="hidden" id="status" name="status" value="benar">
                            <input type="hidden" name="username_user" value="<?php echo $rekaman->username_user ?>">
                            <input type="hidden" name="nama_user" value="<?php echo $rekaman->nama_user ?>">
                            <input type="hidden" name="isi_posting" value="<?php echo $rekaman->nama_user.' telah menyelesaikan tugas '.$rekaman->nama_materi.' huruf '.$rekaman->nama_submateri.' ('.$rekaman->huruf_submateri.')' ?>">
                            <input type="hidden" name="video" value="<?php echo $rekaman->video ?>">
                            <input type="hidden" name="video_materi" value="<?php echo $rekaman->nama_materi ?>">
                            <input type="hidden" name="video_submateri" value="<?php echo $rekaman->nama_submateri ?>">
                            <textarea name="pesan" id="pesan" autocomplete="off" class="form-control mb-1" rows="4"></textarea>
                            <small class="form-text text-muted text-left">Pesan dapat Anda kosongkan</small>
                            ...
                            <button type="button" id="salah" data-toggle="collapse" data-target="#videokoreksi" class="btn btn-sm btn-danger btn-icon-split m-1">
                              <span class="icon">
            ...
            <div class="collapse" id="videokoreksi">
              <div class="row"> 
                <div class="col-12">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <h4 class="m-0 font-weight-bold text-primary">Video Koreksi</h4>
                    </div>
  ...
  <!-- End of Page Wrapper -->
    ...
    <script>
      ...
      function stopRecording() {
        ...
        const filename = "<?php echo str_replace(' ', '', 'koreksi'.$rekaman->username_user).$rekaman->nama_materi.$rekaman->nama_submateri ?>";
        ...
        upld.href = "#";
        upld.innerHTML = "<i class='fa fa-upload'></i> Unggah Koreksi";
        upld.addEventListener("click", function(event){
          event.preventDefault();
          var konfirmasi = confirm("Apakah Anda yakin akan menggunggah video ini?");
          if (konfirmasi) {
            ...
            var fd = new FormData();
            fd.append("video_guru", blob, filename);
            fd.append("status", "salah");
            fd.append("pesan", document.getElementById("pesan").value);
            xhr.open("POST","<?php echo site_url('Controller_guru/nilaitugas/'.$rekaman->id.'/'.$rekaman->username_user.'/'.$rekaman->submateri) ?>",true);
            xhr.send(fd);
            $('#loadingModal').modal('show');
            xhr.addEventListener('load', function(){
              document.getElementById('loading').innerHTML = '<i class="fa fa-check fa-5x"></i>&nbsp;&nbsp;&nbsp;Video berhasil terunggah';
              setTimeout(function(){
                window.location.replace("<?php echo site_url('guru/tugassiswa') ?>");
              }, 3000);
            });

                    ...
                    <div class="col-xl-6 col-lg-6">
                      <div class="row form-group">
                        ...
                        <div class="col-xl-10 col-xl-10 text-center">
                          ...
                          <button type="submit" id="benar" class="btn btn-sm btn-success btn-icon-split m-1">
                            <span class="icon">
                          ...
                          <button type="submit" id="salah" class="btn btn-sm btn-danger btn-icon-split m-1">
                            <span class="icon">
  ...
  <!-- End of Page Wrapper -->
    ...
    <script>
      $('#benar').click(function(){
        document.getElementById('status').value = "benar";
      });

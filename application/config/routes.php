...
$route['guru/rincianshare/(:num)/(:any)/(:any)'] = 'Controller_guru/rincianshare/$1/$2/$3';
$route['guru/rincianreflect/(:num)/(:any)/(:any)'] = 'Controller_guru/rincianreflect/$1/$2/$3';
...
$route['guru/soal/(:any)/(:any)'] = 'Controller_guru/soal/$1/$2';
$route['guru/tambahsoal/(:any)/(:any)']['get'] = 'Controller_guru/tambahsoal/$1/$2';
$route['guru/tambahsoal/(:any)/(:any)']['post'] = 'Controller_guru/addsoal/$1/$2';
...
$route['rincianshare/(:num)/(:any)/(:any)'] = 'Controller_siswa/rincianshare/$1/$2/$3';
$route['rincianreflect/(:num)/(:any)/(:any)'] = 'Controller_siswa/rincianreflect/$1/$2/$3';
$route['dashboard'] = 'Controller_siswa/dashboard';
$route['soal/(:any)/(:any)'] = 'Controller_siswa/soal/$1/$2';
$route['simpanjawaban'] = 'Controller_siswa/simpanjawaban';

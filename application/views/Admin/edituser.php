              ...
              <div class="col-md-8">
                <div class="card shadow mb-4">
                    ...
                    <div class="row">
                      <div class="col">
                        <h4 class="align-middle m-0 font-weight-bold text-primary">
                          Sunting <?php echo $user->nama_user; ?>
                        </h4>
                      </div>
                      <div class="col-auto">
                  ...
                  <div class="card-body pb-2">
                    <form action="<?php echo site_url('Controller_admin/edituser/'.$user->id_user) ?>" method="POST">
                      <div class="row form-group">
                          <label class="col-md-4 text-md-right" for="username">Username</label>
                          <div class="col-md-8">
                              <input type="hidden" value="<?php echo $user->username_user?>" name="cek">
                              <input type="text" value="<?php echo $user->username_user?>" id="username" name="username" class="form-control" placeholder="Username" required>
                          </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-md-8">
                          <div class="input-group">
                            <input id="pass" value="<?php echo $user->password_user ?>" type="password" autocomplete="off" class="form-control" name="pass" placeholder="Password Lama" onchange="tombol()" readonly>
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-md-8">
                          <input type="text" value="<?php echo $user->nama_user ?>" name="nama" class="form-control" placeholder="Nama" required>
                        </div>
                      </div>
                      <div class="row form-group">
                        ...
                        <div class="col-md-8">
                          <div class="custom-control custom-radio">
                            <input <?php echo $user->level_user == '2' ? 'checked' : '' ; ?> value="2" type="radio" id="guru" name="level" class="custom-control-input" required>
                            <label class="custom-control-label" for="guru">Guru</label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input <?php echo $user->level_user == '3' ? 'checked' : '' ; ?> value="3" type="radio" id="siswa" name="level" class="custom-control-input">

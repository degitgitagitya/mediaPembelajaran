...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<div class="row justify-content-center">
            <div class="col-5">
              <h3 class="font-weight-bold text-primary text-center"><i>Creative Learning</i></h3>  
              <hr>
            </div>
        </div>
								...
								<tbody>
									...
									<tr>
										...
										<td class="align-middle text-center">
											...
											if ($avg != 0) {
											?>
												<br><a href="<?php echo site_url('rincianshare/'.$this->session->userdata('id').'/'.$datmateri->nama_materi.'/'.$datsub->nama_submateri) ?>" class="text-decoration-none">Rincian</a>
											<?php } ?>
										</td>
										<td class="align-middle text-center">
											<?php
												...
												if ($totalpenilai == 0 || $refflect == 0) {
													echo "Belum terlewati";
												}else{
													if ($refflect > 0 && $refflect <= 1){
														echo "Kurang";
											...
											?>
											<br><a href="<?php echo site_url('rincianreflect/'.$this->session->userdata('id').'/'.$datmateri->nama_materi.'/'.$datsub->nama_submateri) ?>" <?php echo $datsub->id_submateri ?>" class="text-decoration-none">Rincian</a>
											<?php
												} 
											?>
										</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-justify">
                	<?php if ($dattahap == 'imagine') { ?>
		                ...
		                <br>
		                Apabila bernilai 0 dapat berarti Anda belum mengerjakan soal tersebut.
		            <?php }else if ($dattahap == 'createplay'){ ?>
		            	Tahap ini melibatkan penilaian dari Anda sendiri (<i>Self Correction</i>) setelah Anda berhasil mengunggah video rekaman untuk dikumpulkan atau dibagikan.<br>
		            	<div class="row mt-2">
		                	<div class="col-8 text-center">
    ...
    <?php } ?>
				...
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						Tabel dibawah ini merupakan hasil rekap semua tahapan <i>Creative Learning</i> Anda yang sudah di kalkulasi otomatis oleh sistem.
						<div class="table-responsive">

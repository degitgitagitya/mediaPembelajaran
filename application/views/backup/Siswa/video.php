            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Ada 5 macam:</h6>
                  <?php for ($i=0; $i < 5; $i++) { ?>
                  <a class="collapse-item" href="<?php echo site_url('materi/'.$listmateri[$i]->id_materi) ?>"><?php echo $listmateri[$i]->nama_materi; ?></a>
                <?php } ?>
              </div>
            </div>
        </li>
  ...
  <!-- End of Page Wrapper -->
    ...
    <script>
      ...
      function stopRecording() {
        ...
        const filename = <?php echo $this->session->userdata('username'); ?>
        ...
        upld.addEventListener("click", function(event){
          ...
          xhr.open("POST","Controller_siswa/uploadvideo",true);
          xhr.send(fd);
        })

                ...
                <div class="card-body">
                  <form id="fileform" method="POST" enctype="multipart/form-data">
                    <div class="text-center">
                      <img src="<?php echo base_url('assets/img/profile/'.$profile[0]->foto_user)?>" alt="" style="width: 200px;height: 200px" class="img-thumbnail rounded-circle mb-4">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-md-9">
                        <div class="input-group">
                          ...
                          <input value="<?php echo $profile[0]->username_user ?>" onchange="tombol()" name="username" id="username" type="text" class="form-control" placeholder="Username">
                        </div>
                      </div>
                    </div>
                    <div class="row form-group">
                      ...
                      <div class="col-md-9">
                        <div class="input-group">
                          ...
                          <input value="<?php echo $profile[0]->nama_user; ?>" onchange="tombol()" name="nama" id="nama" type="text" class="form-control" placeholder="Nama Anda">
                        </div>
                      </div>
                    </div>
                    <hr>
  ...
  <!-- End of Page Wrapper -->
    ...
    <script>
      ...
      fileform.addEventListener("submit", function(event){
        ...
        xhr.open("POST","<?php echo site_url('Controller_home/suntingprofile/'.$this->session->userdata('id')); ?>",true);
        xhr.send(fd);
        if (document.getElementById("gambar").files.length != 0){
          ...
          xhr.addEventListener('load', function(){
            ...
            setTimeout(function(){
              window.location.replace("<?php echo site_url('profile'); ?>");
            }, 3000);
          });
        }else{
          window.location.replace("<?php echo site_url('profile'); ?>");

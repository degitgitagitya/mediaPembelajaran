        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
                <div class="col">
                  <h3 class="m-0 mb-2 font-weight-bold text-primary">Pengertian & Manfaat Makhorijul Huruf</h3>
                </div>
                <div class="col-auto">
                ...
                <table class="table table-striped" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a href="<?php echo site_url('guru/soal/pengertian/null') ?>" class="btn btn-secondary"><i class="fa fa-eye"></i></a>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Pengertian & Manfaat</h5>
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="text-justify">
                  ...
                  <a href="<?php echo site_url('guru/soal/'.$materi->nama_materi.'/null') ?>" class="btn btn-block btn-secondary mb-3">Lihat Soal <?php echo $materi->nama_materi; ?></a>
                </div>
                <div class="table-responsive">
                  <table class="table table-striped" width="100%" cellspacing="0">
                    <thead class="text-center">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="align-middle text-center">
                          <a href="<?php echo site_url('guru/soal/'.$materi->nama_materi.'/'.$sub->nama_submateri) ?>" class="btn btn-secondary"><i class="fa fa-eye"></i></a>
                        </td>
                      </tr>
                      <?php
                          $no++; }

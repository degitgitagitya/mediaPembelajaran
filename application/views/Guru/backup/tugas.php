            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="dataTable<?php echo $table ?>" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      <?php
                        $no = 1;
                        $id = $materi->id_materi;
                        foreach ($rekaman as $sub) {
                          if ($id == $sub->id_materi) {
                      ?>
                      <tr>
                        <td class="align-middle text-center"><?php echo $no; ?></td>
                        <td class="align-middle"><?php echo $sub->nama_user; ?></td>
                        <td class="align-middle text-center" style="font-size: 14pt;"><?php echo $sub->nama_submateri; ?> (<b><?php echo $sub->huruf_submateri; ?></b>)</td>
                        <?php if ($sub->guru != NULL) { ?>
                        <td class="align-middle text-center">
                          <?php if ($sub->status == 'Sudah benar') {?>
                            <span class="text-success"><?php echo $sub->status.', '; ?></span>
                          <?php }else{ ?>
                            <span class="text-danger"><?php echo $sub->status.', '; ?></span>
                          <?php } ?>
                          diperiksa oleh <?php foreach ($guru as $namaguru){ echo $pemeriksa = ($namaguru->id_user == $sub->guru) ? $namaguru->nama_user : false ;} ?>
                        </td>
                        <td class="align-middle text-center">
                        ...
                        <td class="align-middle text-center">
                          <a href="<?php echo site_url ('guru/videotugas/'.$sub->id)?>" class="btn btn-danger"><i class="fa fa-play"></i></a>
                        </td>
                        <?php } ?>
                      </tr>
                      <?php
